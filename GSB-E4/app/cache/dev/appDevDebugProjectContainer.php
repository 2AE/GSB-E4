...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['pg_gsb_frais.pdo'] = new \Pg\GsbFraisBundle\services\PdoGsb('mysql:host=localhost', 'dbname=gsbfraiso', 'root', 'root');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('566f1d36e97952.17772540')), true);
